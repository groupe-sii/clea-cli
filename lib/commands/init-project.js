  ...
  start () {
    ...
    if (!this.options.makeItProgressive) {
      excludedFiles = excludedFiles.concat([
        'src/public/assets/icon-64x64.png',
        'src/public/assets/icon-128x128.png',
        'src/public/assets/icon-144x144.png',
        'src/public/assets/icon-152x152.png',
        'src/public/assets/icon-192x192.png',
