...
class InitProject {
  ...
  templatesFolder () {
    if (InitProject.APPLICATION.includes(this.type)) {
      return 'application';
    }

    if (InitProject.LIBRARY.includes(this.type)) {
      return 'library';
    }
  }
...
InitProject.APPLICATION = ['application', 'app'];
InitProject.LIBRARY = ['library', 'lib'];
